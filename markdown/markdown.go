...
// EscapeAndWrapInInlineCodeBlock escapes te string and then wraps it in an inline code block
func EscapeAndWrapInInlineCodeBlock(userInput string) string {
	return WrapInInlineCodeBlock(Escape(userInput))
}
